...
IMPORTANT: Cvičení probíhají vzhledem k vládním opatřením až do odvolání vzdáleně,
v čase dle rozvrhu.
Cičení se konají v aplikaci **Teams**.
Pokud jste si předmět zapsali nedávno a v aplikaci nejste součástí příslušného teamu,
můžeme vás manuálně přidat (ale musíte se nám ozvat např. e-mailem).
...
kterou můžete plnit během cvičení a/nebo později.
